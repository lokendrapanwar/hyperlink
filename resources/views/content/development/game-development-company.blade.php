...
<main>
<section class="sect-pad-tb get-a-qoute-sect pt-4">
<div class="container">
...
<h1 class="main-title mb-3 pt-1 pt-md-5 main-title-1 main-title-11 services-title c-black"><span>Hyperlink</span> <span>InfoSystem</span> <p class="desc mb-0 mt-1">Ranked as <b>#1 Game Development</b> Company</h1>
<h2 class="title mb-0"><b>HIRE GAME DEVELOPER</b><p class="desc mb-0 mt-1"><b>@ $50/HR</b></p></h2>
</div>
<div class="col-12 col-md-10 col-lg-10 col-xl-10 text-center mb-5 mt-3">
<div class="m-auto d-flex justify-content-center">
<label class="mb-0 d-flex align-items-center justify-content-center read-more-btn"><a href="../contact" class="ml-3" title="">Get A Quote <img class="ml-3" src="../frontend_assets/img/arrow-right-white.svg" alt="right arrow"></a></label>
</div>
</div>
<div class="col-12 col-md-10 col-lg-10 col-xl-10 text-center">
<img class="img-fluid" src="../frontend_assets/img/game-development/game-development.png" alt="mobile game development">
</div>
</div>
</div>
</section>
...
<section class="sect-pad-b section pt-0">
<div class="container text-left">
<h2 class="main-title mb-2 mt-60 title-services title-overview c-black">Game Development</h2>
<p class="mt-3 mb-0 desc">With the gaming business turning into a strong, multi-billion-dollar substance, the necessities for games introduced in the market are expanding in mathematical movement. In this way, picking the organization to develop your game is an essential choice. With our extraordinary blend of involvement and skill, we give full-cycle game development services to make your title a religion exemplary, a social peculiarity or, at any rate, a high-netting crowd top choice.<br><br>Hyperlink Infosystem can assist you with developing a game with the most elevated level of quality. Our game developers and QA team will overcome any issues with development and delivery with a careful testing cycle. Before we deliver the final product, the Hyperlink QA testing team always tests the gaming solution to eliminate any defects that slipped through in the developing phase, along with any significant updates that need to be upgraded.<br><br>An ideal fit for games overpowered with graphics, which is normal for first-individual shooters, procedures, secrecy, and action-adventure games enables Hyperlink game developers to develop dazzling visual encounters for gamers across the globe. Incredible Engine is a self-evident and conventional decision for AAA titles and plum for game development organizations. With a wide involvement with UE, Hyperlink game development company is here to convey market-cutthroat games.</p>
</div>
</section>
<section class="sect-pad-b section">
<div class="container text-left">
<div class="row justify-content-center">
<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-3 mb-4 align-self-center">
<h2 class="main-title mb-0 pt-3 title-services title-serv-sol c-black">Services We Offer</h2>
</div>
...
<img class="img-fluid" src="../frontend_assets/img/game-development/serv-game-1.jpg" alt="mobile game development">
</a>
<div class="game-content position-absolute" style="opacity: 1">
<h2 class="game-title text-capitalize c-white mb-2 mt-0">Mobile</h2>
<span class="game-type text-uppercase c-white">Game development</span>
</div>
</div>
</div>
<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 mb-4">
<div class="game-img-box-small position-relative m-2 m-md-0 m-lg-2">
<a href="javascript:void(0);">
<img class="img-fluid" src="../frontend_assets/img/game-development/serv-game-2.jpg" alt="web game development">
</a>
<div class="game-content position-absolute" style="opacity: 1">
<h2 class="game-title text-capitalize c-white mb-2 mt-0">Web</h2>
<span class="game-type text-uppercase c-white">Game development</span>
</div>
</div>
</div>
...
<div class="game-img-box-small position-relative m-2 m-md-0 m-lg-2">
<a href="javascript:void(0);">
<img class="img-fluid" src="../frontend_assets/img/game-development/serv-game-3.jpg" alt="metaverse nft game development">
</a>
<div class="game-content position-absolute" style="opacity: 1">
<h2 class="game-title text-capitalize c-white mb-2 mt-0">Metaverse NFT</h2>
<span class="game-type text-uppercase c-white">Game development</span>
</div>
</div>
</div>
...
<div class="game-img-box-small position-relative m-2 m-md-0 m-lg-2">
<a href="javascript:void(0);">
<img class="img-fluid" src="../frontend_assets/img/game-development/serv-game-7.jpg" alt="html5 game development">
</a>
<div class="game-content position-absolute" style="opacity: 1">
<h2 class="game-title text-capitalize c-white mb-2 mt-0">HTML5</h2>
 <span class="game-type text-uppercase c-white">Game development</span>
</div>
</div>
</div>
...
<div class="game-img-box-small position-relative m-2 m-md-0 m-lg-2">
<a href="javascript:void(0);">
<img class="img-fluid" src="../frontend_assets/img/game-development/serv-game-5.jpg" alt="unity3D game development">
</a>
<div class="game-content position-absolute" style="opacity: 1">
<h2 class="game-title text-capitalize c-white mb-2 mt-0">Unity3D</h2>
<span class="game-type text-uppercase c-white">Game development</span>
</div>
</div>
</div>
...
<div class="game-img-box-small position-relative m-2 m-md-0 m-lg-2">
<a href="javascript:void(0);">
<img class="img-fluid" src="../frontend_assets/img/game-development/serv-game-6.jpg" alt="unreal engine game development">
</a>
<div class="game-content position-absolute" style="opacity: 1">
<h2 class="game-title text-capitalize c-white mb-2 mt-0">Unreal Engine</h2>
<span class="game-type text-uppercase c-white">Game development</span>
</div>
</div>
</div>
...
<div class="game-img-box-small position-relative m-2 m-md-0 m-lg-2">
<a href="javascript:void(0);">
<img class="img-fluid" src="../frontend_assets/img/game-development/serv-game-4.jpg" alt="2d 3d game development">
</a>
<div class="game-content position-absolute" style="opacity: 1">
<h2 class="game-title text-capitalize c-white mb-2 mt-0">2D/3D</h2>
<span class="game-type text-uppercase c-white">Game development</span>
</div>
</div>
</div>
...
<div class="game-img-box-small position-relative m-2 m-md-0 m-lg-2">
<a href="javascript:void(0);">
<img class="img-fluid" src="../frontend_assets/img/game-development/serv-game-8.jpg" alt="character creation">
</a>
<div class="game-content position-absolute" style="opacity: 1">
<h2 class="game-title text-capitalize c-white mb-2 mt-0">Character</h2>
<span class="game-type text-uppercase c-white">Creation</span>
</div>
</div>
</div>
<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 mb-4">
<div class="game-img-box-small position-relative m-2 m-md-0 m-lg-2">
<a href="javascript:void(0);">
<img class="img-fluid" src="../frontend_assets/img/game-development/serv-game-9.jpg" alt="concept art">
</a>
<div class="game-content position-absolute" style="opacity: 1">
<h2 class="game-title text-capitalize c-white mb-2 mt-0">Concept</h2>
<span class="game-type text-uppercase c-white">Art</span>
</div>
</div>
</div>
</div>
...
<section class="sect-pad-b blockchain-serv-sol">
<div class="container">
<div class="row justify-content-center">
<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-3 align-self-center">
<h2 class="main-title mb-0 pt-3 title-services title-serv-sol-3 c-black">Type of Games</h2>
</div>
<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mt-3">
<div class="card-box p-3 p-md-4 text-center d-flex justify-content-center">
<div class="d-flex flex-column align-self-center">
<img width="55" height="55" class="mx-auto my-0" src="../frontend_assets/img/game-development/card-game-app.svg" alt="card game app">
<h2 class="h6 mb-0 mt-3"><b style="line-height: 24px;">Card Games</b></h2>
</div>
</div>
</div>
<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mt-3">
<div class="card-box p-3 p-md-4 text-center d-flex justify-content-center">
<div class="d-flex flex-column align-self-center">
<img width="55" height="55" class="m-auto" src="../frontend_assets/img/game-development/kids-game-app.svg" alt="kids game app">
<h2 class="h6 mb-0 mt-3"><b style="line-height: 24px;">Kids Game App</b></h2>
</div>
</div>
</div>
<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mt-3">
<div class="card-box p-3 p-md-4 text-center d-flex justify-content-center">
<div class="d-flex flex-column align-self-center">
<img width="55" height="55" class="m-auto" src="../frontend_assets/img/game-development/simulator-game-app.svg" alt="simulator game">
<h2 class="h6 mb-0 mt-3"><b style="line-height: 24px;">Simulator Game App</b></h2>
</div>
</div>
</div>
<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mt-3 ">
<div class="card-box p-3 p-md-4 text-center d-flex justify-content-center">
<div class="d-flex flex-column align-self-center">
<img width="55" height="55" class="m-auto" src="../frontend_assets/img/game-development/fps-shooting-game.svg" alt="fps shooting game">
<h2 class="h6 mb-0 mt-3"><b style="line-height: 24px;">FPS Shooting Games</b></h2>
</div>
</div>
</div>
<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mt-3">
<div class="card-box p-3 p-md-4 text-center d-flex justify-content-center">
 <div class="d-flex flex-column align-self-center">
 <img width="55" height="55" class="m-auto" src="../frontend_assets/img/game-development/ar-game.svg" alt="ar game">
<h2 class="h6 mb-0 mt-3"><b style="line-height: 24px;">AR Games</b></h2>
</div>
</div>
</div>
<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mt-3">
<div class="card-box p-3 p-md-4 text-center d-flex justify-content-center">
<div class="d-flex flex-column align-self-center">
<img width="55" height="55" class="m-auto" src="../frontend_assets/img/game-development/vr-game.svg" alt="vr game">
<h2 class="h6 mb-0 mt-3"><b style="line-height: 24px;">VR Games</b></h2>
</div>
</div>
</div>
<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mt-3">
<div class="card-box p-3 p-md-4 text-center d-flex justify-content-center">
<div class="d-flex flex-column align-self-center">
<img width="55" height="55" class="m-auto" src="../frontend_assets/img/game-development/puzzle-game.svg" alt="puzzle games">
<h2 class="h6 mb-0 mt-3"><b style="line-height: 24px;">Puzzle Games</b></h2>
</div>
</div>
</div>
<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mt-3">
<div class="card-box p-3 p-md-4 text-center d-flex justify-content-center">
<div class="d-flex flex-column align-self-center">
<img width="55" height="55" class="m-auto" src="../frontend_assets/img/game-development/metaverse-nft-game.svg" alt="metaverse nft game">
<h2 class="h6 mb-0 mt-3"><b style="line-height: 24px;">Metaverse NFT Game</b></h2>
</div>
</div>
</div>
<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mt-3">
<div class="card-box p-3 p-md-4 text-center d-flex justify-content-center">
<div class="d-flex flex-column align-self-center">
<img width="55" height="55" class="m-auto" src="../frontend_assets/img/game-development/endless-runner-game.svg" alt="endless runner game">
<h2 class="h6 mb-0 mt-3"><b style="line-height: 24px;">Endless Runner Game</b></h2>
</div>
</div>
</div>
</div>
...
<div class="row justify-content-center">
<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-3 mb-4 align-self-center">
<h2 class="main-title mb-0 pt-3 title-services title-serv-sol-2 c-black">Our Featured</h2>
</div>
...
<h2 class="game-title text-capitalize c-white mb-0 mt-2 mt-md-0 mt-lg-2">Ludo game</h2>
</div>
</a>
</div>
</div>
...
<h2 class="game-title text-capitalize c-white mb-0 mt-2 mt-md-0 mt-lg-2">Rummy Game</h2>
</div>
</a>
</div>
</div>
...
<div class="game-content position-absolute">
<span class="game-type text-uppercase c-white">Mobile, Tablet</span>
<h2 class="game-title text-capitalize c-white mb-0 mt-2 mt-md-0 mt-lg-2">Zombie Abomination</h2>
</div>
</a>
</div>
</div>
...
<div class="game-content position-absolute">
<span class="game-type text-uppercase c-white">Mobile, Tablet</span>
<h2 class="game-title text-capitalize c-white mb-0 mt-2 mt-md-0 mt-lg-2">poker - online casino game</h2>
</div>
</a>
</div>
</div>
...
<div class="game-content position-absolute">
<span class="game-type text-uppercase c-white">Mobile, Tablet</span>
 <h2 class="game-title text-capitalize c-white mb-0 mt-2 mt-md-0 mt-lg-2">Austria Map puzzle</h2>
</div>
</a>
</div>
</div>
...
<div class="game-content position-absolute">
<span class="game-type text-uppercase c-white">Mobile</span>
<h2 class="game-title text-capitalize c-white mb-0 mt-2 mt-md-0 mt-lg-2">Alien Shooter AR</h2>
</div>
</a>
</div>
</div>
...
<div class="game-content position-absolute">
<span class="game-type text-uppercase c-white">Mobile, Tablet</span>
<h2 class="game-title text-capitalize c-white mb-0 mt-2 mt-md-0 mt-lg-2">Thunder Bike Racing</h2>
</div>
</a>
</div>
</div>
...
<div class="game-content position-absolute">
<span class="game-type text-uppercase c-white">Mobile, Tablet</span>
<h2 class="game-title text-capitalize c-white mb-0 mt-2 mt-md-0 mt-lg-2">new senso puzzle</h2>
</div>
</a>
</div>
</div>
...
<div class="game-content position-absolute">
<span class="game-type text-uppercase c-white">Mobile, Tablet</span>
<h2 class="game-title text-capitalize c-white mb-0 mt-2 mt-md-0 mt-lg-2">Switzerland Map puzzle</h2>
</div>
</a>
</div>
</div>
...
<div class="game-content position-absolute">
<span class="game-type text-uppercase c-white">Mobile, Tablet</span>
<h2 class="game-title text-capitalize c-white mb-0 mt-2 mt-md-0 mt-lg-2">Fantasy death racer</h2>
</div>
</a>
</div>
</div>
...
<div class="game-content position-absolute">
<span class="game-type text-uppercase c-white">Mobile</span>
<h2 class="game-title text-capitalize c-white mb-0 mt-2 mt-md-0 mt-lg-2">Pool table</h2>
</div>
</a>
</div>
</div>
...
<div class="game-content position-absolute">
<span class="game-type text-uppercase c-white">Mobile, Tablet</span>
<h2 class="game-title text-capitalize c-white mb-0 mt-2 mt-md-0 mt-lg-2">VirtuHunt hunting</h2>
</div>
</a>
</div>
</div>
...
<div class="game-content position-absolute">
<span class="game-type text-uppercase c-white">Mobile, Tablet</span>
<h2 class="game-title text-capitalize c-white mb-0 mt-2 mt-md-0 mt-lg-2">flappy yourself</h2>
</div>
</a>
</div>
</div>
...
<div class="game-content position-absolute">
<span class="game-type text-uppercase c-white">Mobile, Tablet</span>
<h2 class="game-title text-capitalize c-white mb-0 mt-2 mt-md-0 mt-lg-2">USA map puzzle</h2>
</div>
</a>
</div>
</div>
...
<div class="game-content position-absolute">
<span class="game-type text-uppercase c-white">Mobile, Tablet</span>
<h2 class="game-title text-capitalize c-white mb-0 mt-2 mt-md-0 mt-lg-2">Puzzmory</h2>
</div>
</a>
</div>
</div>
...
<section class="sect-pad-tb bg-light mt-0">
<div class="container">
<div class="row justify-content-center">
<div class="col-12 col-md-12 col-lg-9 col-xl-10 text-center mb-5">
<h2 class="main-title mb-3 pt-3 pt-md-4 pt-lg-4 pt-xl-5 services-title cs-technology-stacks-title c-black">Technologies and Game Engines We Use</h2>
<p class="desc mb-3">We have used the latest technologies that can justify client requirements at the best to deliver bug-free solutions.</p>
</div>
<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
<div class="tech-logos-swip swiper-container w-100 h-100">
<div class="swiper-wrapper text-center">
<div class="swiper-slide"><img src="../frontend_assets/img/techn/unity.png" alt="unity3d"></div>
<div class="swiper-slide"><img src="../frontend_assets/img/techn/unreal.png" alt="unreal"></div>
<div class="swiper-slide"><img src="../frontend_assets/img/techn/opengl.png" alt="opengl"></div>
<div class="swiper-slide"><img src="../frontend_assets/img/techn/webgl.png" alt="webgl"></div>
<div class="swiper-slide"><img src="../frontend_assets/img/techn/vuforia.png" alt="vuforia"></div>
<div class="swiper-slide"><img src="../frontend_assets/img/techn/artoolkit.png" alt="artoolkit"></div>
<div class="swiper-slide"><img src="../frontend_assets/img/techn/cocos.png" alt="cocos2d x"></div>
<div class="swiper-slide"><img src="../frontend_assets/img/techn/html.png" alt="html"></div>
<div class="swiper-slide"><img src="../frontend_assets/img/techn/angular.png" alt="angular"></div>
</div>
 </div>
</div>
</div>
...
<section class="sect-pad-t faq-sect">
<div class="container">
<div class="row justify-content-center">
<div class="col-12 col-md-12 col-lg-12 text-center mb-5">
<h3 class="main-title mb-3 mt-60 title-faq c-black">Frequently Asked Questions</h3>
</div>
<div class="col-12 col-md-12 col-lg-12 col-xl-11">
<div class="accordion">
<div class="accordion-item">
<button id="accordion-button-1" aria-expanded="false"><span class="accordion-title">1. What type of tools & technologies does Hyperlink Infosystem use for game development?</span><span class="icon" aria-hidden="true"></span></button>
<div class="accordion-content">
<p class="desc">The wide universe of game app development requires considerable knowledge of the famous game engines. Our game app development team installs their inventively splendid game themes in the specialized specifications of the accompanying famous programming tools and game engines</p>
<ul>
<li>Cocos 2D</li>
<li>Cocos 2D-X</li>
<li>Unity 3D</li>
...
<div class="accordion-item">
<button id="accordion-button-2" aria-expanded="false"><span class="accordion-title">2. Will Hyperlink Infosystem assist in publishing my games?</span><span class="icon" aria-hidden="true"></span></button>
<div class="accordion-content">
<p class="desc">When you hand over your game development project requirements into the imaginative hands of our game developers, Hyperlink Infosystem will be with you till the last phase of publishing your games and sending them live on the web.</p>
</div>
</div>
<div class="accordion-item">
<button id="accordion-button-3" aria-expanded="false"><span class="accordion-title">3. Can you help me develop one mobile gaming application which can support all the platforms like iPhone, iPad, Android?</span><span class="icon" aria-hidden="true"></span></button>
<div class="accordion-content">
<p class="desc">Yes, Hyperlink game developers can develop applications/games that would work on all platforms. For such development, we choose to go for cross-platform mobile development in which our developers use frameworks that are used to develop the main application and then deploy it across all the platforms you want. For more information on our cross-platform gaming development services, you can reach out to us with your requirements, and we will guide you for the further process.</p>
</div>
</div>
<div class="accordion-item">
<button id="accordion-button-4" aria-expanded="false"><span class="accordion-title">4. What is the process involved in game development?</span><span class="icon" aria-hidden="true"></span></button>
<div class="accordion-content">
<p class="desc">At hyperlink Infosystem, the entire process of the evolution of mobile game development is categorized into various stages such as pre-production, production and post-production.</p>
<ul>
<li><b>Pre-Production Stage includes</b></li>
<li>Finalizing concept and theme of the game</li>
<li>Storyline</li>
<li>Finalizing Project Plan</li>
<li>Architecture Design</li>
</ul>
<ul>
<li><b>The Production Stage includes</b></li>
<li>Design</li>
<li>Development</li>
<li>Testing & QA</li>
</ul>
<ul>
<li><b>The post-Production Stage includes</b></li>
<li>Deployment</li>
<li>Maintenance</li>
</ul>
</div>
...
<div class="accordion-item">
<button id="accordion-button-5" aria-expanded="false"><span class="accordion-title">5. Can you develop multiplayer games without a server?</span><span class="icon" aria-hidden="true"></span></button>
<div class="accordion-content">
<p class="desc">Our team of developers are experienced enough to develop gaming solutions with the server or without the server as well. But it is always advisable to have a gaming solution with the server as it solves various security problems, keeping software and data in check to protect them. It keeps your gaming solution safe from cyber threats and alteration as well.</p>
</div>
</div>
<div class="accordion-item">
<button id="accordion-button-6" aria-expanded="false"><span class="accordion-title">6. Which game engine is superior to developing VR and AR games: Unreal or Unity?</span><span class="icon" aria-hidden="true"></span></button>
<div class="accordion-content">
<p class="desc">For AR it is difficult to look past Unity. It has been supporting AR for much longer than Unreal and is as yet the main platform that can develop holo lens applications. But when it comes to VR it is a totally different question. Again on the off chance that you are looking toward more versatile VR, Unity's mobile support will help a ton.</p>
</div>
</div>
</div>
</div>
...
<li><a href="../iphone-application-development.htm"><img src="../frontend_assets/img/services-we-offer/apple-icon.svg" class="mr-3" width="23px" height="23px" alt="ios">iOS App</a></li>
...
<div class="pt-1">
<label class="mb-0 d-inline-flex align-items-center read-more-btn mt-4 mt-md-2 mt-lg-4"><a href="default.htm" class="ml-3" title="">Read more <img class="ml-3" src="../frontend_assets/img/arrow-right-white.svg" alt="right arrow"></a></label>
</div>
</div>
</div>
<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mt-3">
...
<ul class="list-unstyled mt-30">
<li><a href="../android-app-development.htm"><img src="../frontend_assets/img/services-we-offer/android.svg" class="mr-3" width="23px" height="23px" alt="android">Android App</a></li>
<li><a href="../iphone-application-development.htm"><img src="../frontend_assets/img/services-we-offer/apple-icon.svg" class="mr-3" width="23px" height="23px" alt="ios">iPhone App</a></li>
<li><a href="../flutter-app-development.htm"><img src="../frontend_assets/img/services-we-offer/flutter.svg" class="mr-3" width="23px" height="23px" alt="flutter">Flutter</a></li>
<li><a href="../react-native-app-development.htm"><img src="../frontend_assets/img/services-we-offer/react-native.svg" class="mr-3" width="23px" height="23px" alt="react-native">React Native</a></li>
<li><a href="../kotlin-app-development.htm"><img src="../frontend_assets/img/services-we-offer/kotlin.svg" class="mr-3" width="23px" height="23px" alt="kotlin">Kotlin</a></li>
<li><a href="../ionic-app-development.htm"><img src="../frontend_assets/img/services-we-offer/ionic.svg" class="mr-3" width="23px" height="23px" alt="ionic  ">Ionic</a></li>
...
<section class="pt-5 hiring-made-easy d-none d-sm-none d-md-none d-lg-none d-xl-block">
<div class="container">
<div class="row no-gutters">
<div class="col-12 col-md-12 col-lg-12 col-xl-12 mb-4">
<div class="text-center">
<h4 class="main-title mb-4 mt-60 title-technologies-we-work c-black">Quick And Easy Steps Of Hiring</h4>
</div>
</div>
<div class="col-12 col-md-12 col-lg-6 col-xl-3 text-center mb-4 mb-md-3 mb-xl-0">
<div class="d-flex flex-row flex-md-column">
<div class="card-box"><svg class="grt-arrow" width="15px" height="29px" viewBox="0 0 15 29"><path d="m.707.707 13.678 13.678-13.678 13.677" fill="none" stroke="#4842A8"></path></svg><div class="step-num justify-content-center d-flex m-auto"><span class="align-self-center">1</span></div></div>
<div class="px-4 py-0 py-md-4 px-md-4 m-text-left">
<h4 class="h5 mt-0 mb-3">Interaction with our Professionals</h4>
<p class="desc my-0">Initially, our professionals will interact with you and learn about your requirements and goals to achieve. Then, we will explain to you about work and methods.</p>
</div>
</div>
</div>
<div class="col-12 col-md-12 col-lg-6 col-xl-3 text-center mb-4 mb-md-3 mb-xl-0">
<div class="d-flex flex-row flex-md-column">
<div class="card-box"><svg class="grt-arrow" width="15px" height="29px" viewBox="0 0 15 29"><path d="m.707.707 13.678 13.678-13.678 13.677" fill="none" stroke="#4842A8"></path></svg><div class="step-num justify-content-center d-flex m-auto"><span class="align-self-center">2</span></div></div>
<div class="px-4 py-0 py-md-4 px-md-4 m-text-left">
<h4 class="h5 mt-0 mb-3">Assign to The Team</h4>
<p class="desc my-0">After knowing your needs, we will assign you to the team or specific individual for the project. Our team of experts will work dedicatedly to accomplish your goal.</p>
</div>
</div>
</div>
<div class="col-12 col-md-12 col-lg-6 col-xl-3 text-center mb-4 mb-md-3 mb-xl-0">
<div class="d-flex flex-row flex-md-column">
<div class="card-box"><svg class="grt-arrow" width="15px" height="29px" viewBox="0 0 15 29"><path d="m.707.707 13.678 13.678-13.678 13.677" fill="none" stroke="#4842A8"></path></svg><div class="step-num justify-content-center d-flex m-auto"><span class="align-self-center">3</span></div></div>
<div class="px-4 py-0 py-md-4 px-md-4 m-text-left">
<h4 class="h5 mt-0 mb-3">Work and Know</h4>
<p class="desc my-0">We provide you with employees or team members who will help you with your work. However, if you are not happy with it, you can inform us. For Hyperlink InfoSystem, we deliver excellence that matches the client's aim.</p>
</div>
</div>
</div>
<div class="col-12 col-md-12 col-lg-6 col-xl-3 text-center mb-4 mb-md-3 mb-xl-0">
<div class="d-flex flex-row flex-md-column">
<div class="card-box"><svg class="grt-arrow" width="15px" height="29px" viewBox="0 0 15 29"><path d="m.707.707 13.678 13.678-13.678 13.677" fill="none" stroke="#4842A8"></path></svg><div class="step-num justify-content-center d-flex m-auto"><span class="align-self-center">4</span></div></div>
<div class="px-4 py-0 py-md-4 px-md-4 m-text-left">
<h4 class="h5 mt-0 mb-3">Final Selection</h4>
<p class="desc my-0">We will assign you the team and team members you select and want for your following projects in our final step.</p>
</div>
</div>
</div>
</div>
...
<section class="pt-5 hiring-made-easy d-block d-sm-block d-md-block d-lg-block d-xl-none">
<div class="container">
<div class="row no-gutters">
<div class="col-12 col-md-12 col-lg-12 col-xl-12 mb-4">
<div class="text-center">
...
<div class="swiper-wrapper">
<div class="swiper-slide">
<div class="d-flex flex-column flex-md-column text-center">
<div class="card-box mb-2 mb-xd-0"><svg class="grt-arrow" width="15px" height="29px" viewBox="0 0 15 29"><path d="m.707.707 13.678 13.678-13.678 13.677" fill="none" stroke="#4842A8"></path></svg><div class="step-num justify-content-center d-flex m-auto"><span class="align-self-center">1</span></div></div>
<div class="px-4 py-0 py-md-3 px-md-3">
<h4 class="h5 mt-0 mb-2 mb-md-3">Interaction with our Professionals</h4>
<p class="desc my-0">Initially, our professionals will interact with you and learn about your requirements and goals to achieve. Then, we will explain to you about work and methods.</p>
</div>
</div>
</div>
<div class="swiper-slide">
<div class="d-flex flex-column flex-md-column text-center">
<div class="card-box mb-2 mb-xd-0"><svg class="grt-arrow" width="15px" height="29px" viewBox="0 0 15 29"><path d="m.707.707 13.678 13.678-13.678 13.677" fill="none" stroke="#4842A8"></path></svg><div class="step-num justify-content-center d-flex m-auto"><span class="align-self-center">2</span></div></div>
<div class="px-4 py-0 py-md-3 px-md-3">
<h4 class="h5 mt-0 mb-2 mb-md-3">Assign to The Team</h4>
<p class="desc my-0">After knowing your needs, we will assign you to the team or specific individual for the project. Our team of experts will work dedicatedly to accomplish your goal.</p>
</div>
</div>
</div>
<div class="swiper-slide">
<div class="d-flex flex-column flex-md-column text-center">
 <div class="card-box mb-2 mb-xd-0"><svg class="grt-arrow" width="15px" height="29px" viewBox="0 0 15 29"><path d="m.707.707 13.678 13.678-13.678 13.677" fill="none" stroke="#4842A8"></path></svg><div class="step-num justify-content-center d-flex m-auto"><span class="align-self-center">3</span></div></div>
<div class="px-4 py-0 py-md-3 px-md-3">
<h4 class="h5 mt-0 mb-2 mb-md-3">Work and Know</h4>
<p class="desc my-0">We provide you with employees or team members who will help you with your work. However, if you are not happy with it, you can inform us. For Hyperlink InfoSystem, we deliver excellence that matches the client's aim.</p>
</div>
</div>
</div>
<div class="swiper-slide">
<div class="d-flex flex-column flex-md-column text-center">
<div class="card-box mb-2 mb-xd-0"><svg class="grt-arrow" width="15px" height="29px" viewBox="0 0 15 29"><path d="m.707.707 13.678 13.678-13.678 13.677" fill="none" stroke="#4842A8"></path></svg><div class="step-num justify-content-center d-flex m-auto"><span class="align-self-center">4</span></div></div>
<div class="px-4 py-0 py-md-3 px-md-3">
<h4 class="h5 mt-0 mb-2 mb-md-3">Final Selection</h4>
<p class="desc my-0">We will assign you the team and team members you select and want for your following projects in our final step.</p>
</div>
</div>
</div>
...
<div class="card-box px-3 py-4 text-center d-flex flex-column justify-content-center">
<h3 class="h6 m-0 align-self-center"><b>Astral Adhesives - Resiwood Winners' Circle Loyalty Program App</b></h3>
<div class="d-flex justify-content-center mt-3">
<span class="tech-chip d-inline-flex mr-1 mt-1 text-capitalize">Android</span>
<span class="tech-chip d-inline-flex mr-1 mt-1 text-capitalize">iOS</span>
<span class="tech-chip d-inline-flex mr-1 mt-1 text-capitalize">Node js</span>
...
<p class="desc mb-0 mt-3">Here, We make almost every genre of applications. You name it and we build it.</p>
</div>
</div>
</div>
...
<p class="desc mb-0">"Hyperlink Infosystem is dependable and responsive to client's request. Always easy and convenient to communicate with them for any issues and support. Gladly recommend them to anyone who wants to build ideas into real products."</p>
<div class="d-flex app-desc text-left flex-column flex-lg-row mt-3 mt-md-3 mt-lg-0">
<picture>
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/neighbor-shopper.png" type="image/png">
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/neighbor-shopper.webp" type="image/webp">
<img loading="lazy" src="../frontend_assets/img/our-client-say/client-icon/neighbor-shopper.webp" alt="neighbor shopper">
</picture>
<div class="ml-0 ml-md-0 ml-lg-3 mt-3 mt-md-3 mt-lg-0">
<h4 class="client-nm text-capitalize">James<br><span class="d-flex mt-1 desc mb-0 text-capitalize justify-content-center justify-content-xl-start">Neighbor Shopper</span><span><img class="align-self-center mr-1" width="20" src="../frontend_assets/img/us-flag.svg" alt="usa"> Massachusetts, USA</span></h4>
</div>
</div>
</div>
</div>
<div class="swiper-slide">
<div class="content-box bg-white text-center d-flex flex-column justify-content-between">
<p class="desc mb-0">"Discovering Hyperlink Infosystem is no doubt one of the highlights of my 2018. They took my idea and brought it to life, beautifully. The team assigned to me was diligent, responsive &amp; patient. They did not try to rush the process so that they could quickly jump onto a new client, instead they treated my app with care as if it was their own. I would highly recommend Hyperlink Infosystem to anyone looking to build something special."</p>
<div class="d-flex app-desc text-left flex-column flex-lg-row mt-3 mt-md-3 mt-lg-0">
<picture>
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/smyllo.png" type="image/png">
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/smyllo.webp" type="image/webp">
<img loading="lazy" src="../frontend_assets/img/our-client-say/client-icon/smyllo.webp" alt="smyllo">
</picture>
<div class="ml-0 ml-md-0 ml-lg-3 mt-3 mt-md-3 mt-lg-0">
<h4 class="client-nm text-capitalize">Founder<br><span class="d-flex mt-1 desc mb-0 text-capitalize justify-content-center">Social Media App</span><span><img class="align-self-center mr-1" width="20" height="20" src="../frontend_assets/img/our-client-say/kenya.svg" alt="kenya">Kenya</span></h4>
</div>
</div>
</div>
</div>
<div class="swiper-slide">
<div class="content-box bg-white text-center d-flex flex-column justify-content-between">
<p class="desc mb-0">"To the teams of Hyperlink Infosystem - excellent job done with very smooth and responsive communication! The teams are very knowledgeable and had given us lots of valuable advices."</p>
<div class="d-flex app-desc text-left flex-column flex-lg-row mt-3 mt-md-3 mt-lg-0">
<picture>
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/oh-my-help.png" type="image/png">
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/oh-my-help.webp" type="image/webp">
<img loading="lazy" src="../frontend_assets/img/our-client-say/client-icon/oh-my-help.webp" alt="oh-my-help">
</picture>
<div class="ml-0 ml-md-0 ml-lg-3 mt-3 mt-md-3 mt-lg-0">
<h4 class="client-nm text-capitalize">Ivan Lau<br><span class="d-flex mt-1 desc mb-0 text-capitalize justify-content-center">CEO & Founder - OhMyHelp</span><span><img class="align-self-center mr-1" width="20" height="20" src="../frontend_assets/img/our-client-say/hong-kong.svg" alt="hong kong">Hong Kong</span></h4>
</div>
</div>
</div>
</div>
<div class="swiper-slide">
<div class="content-box bg-white text-center d-flex flex-column justify-content-between">
<p class="desc mb-0">"Thoughtfully integrating consumer feedback to improve the UX/UI, Hyperlink InfoSystem
...
<div class="d-flex app-desc text-left flex-column flex-lg-row mt-3 mt-md-3 mt-lg-0">
<picture>
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/skkyn.png" type="image/png">
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/skkyn.webp" type="image/webp">
<img loading="lazy" src="../frontend_assets/img/our-client-say/client-icon/skkyn.webp" alt="skkyn">
</picture>
<div class="ml-0 ml-md-0 ml-lg-3 mt-3 mt-md-3 mt-lg-0">
<h4 class="client-nm text-capitalize">Sujai Soy<br><span class="d-flex mt-1 desc mb-0 text-capitalize justify-content-center">Skkyn Technologies - Owner</span><span><img class="align-self-center mr-1" width="20" height="20" src="../frontend_assets/img/our-client-say/united-arab-emirates.svg" alt="uae"> Dubai, UAE</span></h4>
</div>
</div>
</div>
</div>
<div class="swiper-slide">
<div class="content-box bg-white text-center d-flex flex-column justify-content-between">
<p class="desc mb-0">"The founder of Hyperlink Infosystem and the rest of his project team have placed
customer service through responsiveness and proper communication above all else, leading to a strong initial product and the opportunity to continue the partnership through multiple iterations and enhancements."</p>
<div class="d-flex app-desc text-left flex-column flex-lg-row mt-3 mt-md-3 mt-lg-0">
<picture>
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/coolcharm.png" type="image/png">
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/coolcharm.webp" type="image/webp">
<img loading="lazy" src="../frontend_assets/img/our-client-say/client-icon/coolcharm.webp" alt="coolcharm">
</picture>
<div class="ml-0 ml-md-0 ml-lg-3 mt-3 mt-md-3 mt-lg-0">
<h4 class="client-nm text-capitalize">Brendan Buchholz<br><span class="d-flex mt-1 desc mb-0 text-capitalize justify-content-center">Founder, Cool Charm Friends</span><span><img class="align-self-center mr-1" width="20" height="20" src="../frontend_assets/img/our-client-say/australia.svg" alt="australia"> Brisbane, Australia</span></h4>
</div>
</div>
</div>
</div>
<div class="swiper-slide">
<div class="content-box bg-white text-center d-flex flex-column justify-content-between">
<p class="desc mb-0">"The client appreciates being able to speak in layman terms to Hyperlink's project
manager. Their technical knowledge and suggestions influenced the evolution of the client's vision."</p>
<div class="d-flex app-desc text-left flex-column flex-lg-row mt-3 mt-md-3 mt-lg-0">
<picture>
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/delviy.png" type="image/png">
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/delviy.webp" type="image/webp">
<img loading="lazy" src="../frontend_assets/img/our-client-say/client-icon/delviy.webp" alt="delviy">
</picture>
<div class="ml-0 ml-md-0 ml-lg-3 mt-3 mt-md-3 mt-lg-0">
<h4 class="client-nm text-capitalize">Arhad Khwaja<br><span class="d-flex mt-1 desc mb-0 text-capitalize justify-content-center">President, Fast Food Franchisee</span><span><img class="align-self-center mr-1" width="20" src="../frontend_assets/img/us-flag.svg" alt="usa"> New York, USA</span></h4>
</div>
</div>
</div>
</div>
<div class="swiper-slide">
<div class="content-box bg-white text-center d-flex flex-column justify-content-between">
<p class="desc mb-0">"Hyperlink InfoSystem has been professional, communicative, and understanding throughout this partnership, and their mobile apps have received very positive feedback from users,
who note that it is much nicer and more user friendly than others of its kind."</p>
<div class="d-flex app-desc text-left flex-column flex-lg-row mt-3 mt-md-3 mt-lg-0">
<picture>
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/buuurp.png" type="image/png">
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/buuurp.webp" type="image/webp">
<img loading="lazy" src="../frontend_assets/img/our-client-say/client-icon/buuurp.webp" alt="buuurp">
</picture>
<div class="ml-0 ml-md-0 ml-lg-3 mt-3 mt-md-3 mt-lg-0">
<h4 class="client-nm text-capitalize">Matthew Berwick<br><span class="d-flex mt-1 desc mb-0 text-capitalize justify-content-center">CoFounder, Buuurp!</span><span><img class="align-self-center mr-1" width="20" src="../frontend_assets/img/uk-flag.svg" alt="uk"> UK</span></h4>
</div>
</div>
</div>
</div>
<div class="swiper-slide">
<div class="content-box bg-white text-center d-flex flex-column justify-content-between">
<p class="desc mb-0">"Hyperlink InfoSystem was diligent and responsive in solving any issues that came up
throughout the development process and still provides excellent support when they are needed. The client feels that Hyperlink has really gone above and beyond with their service."</p>
<div class="d-flex app-desc text-left flex-column flex-lg-row mt-3 mt-md-3 mt-lg-0">
<picture>
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/jincky.png" type="image/png">
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/jincky.webp" type="image/webp">
<img loading="lazy" src="../frontend_assets/img/our-client-say/client-icon/jincky.webp" alt="jincky">
</picture>
<div class="ml-0 ml-md-0 ml-lg-3 mt-3 mt-md-3 mt-lg-0">
<h4 class="client-nm text-capitalize">Omar Boyd </h4>
<span class="d-flex mt-1 desc mb-0 text-capitalize justify-content-center">CoFounder, OanZ Holdings</span><span><img class="align-self-center mr-1" width="20" height="20" src="../frontend_assets/img/our-client-say/canada.svg" alt="canada">Canada</span>
</div>
</div>
</div>
</div>
<div class="swiper-slide">
<div class="content-box bg-white text-center d-flex flex-column justify-content-between">
<p class="desc mb-0">"Hyperlink InfoSystem was able to communicate effectively with the client, despite the
fact that both parties were using a second language, delivering on all project requirements. The client notes that Hyperlink works well as a team and is very responsive."</p>
<div class="d-flex app-desc text-left flex-column flex-lg-row mt-3 mt-md-3 mt-lg-0">
<picture>
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/funcom.png" type="image/png">
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/funcom.webp" type="image/webp">
<img loading="lazy" src="../frontend_assets/img/our-client-say/client-icon/funcom.webp" alt="funcom">
</picture>
<div class="ml-0 ml-md-0 ml-lg-3 mt-3 mt-md-3 mt-lg-0">
<h4 class="client-nm text-capitalize">Sumood Almesallam <span class="d-flex mt-1 desc mb-0 text-capitalize justify-content-center">General Manager, Al Salam, Kuwait City</span><span><img class="align-self-center mr-1" width="20" height="20" src="../frontend_assets/img/our-client-say/united-arab-emirates.svg" alt="kuwait"> Kuwait</span></h4>
</div>
</div>
</div>
</div>
<div class="swiper-slide">
<div class="content-box bg-white text-center d-flex flex-column justify-content-between">
<p class="desc mb-0">"Hyperlink InfoSystem met all of the client's requirements for the application and made suggestions for improvement when possible. The client describes Hyperlink as flexible, knowledgeable, and understanding."</p>
<div class="d-flex app-desc text-left flex-column flex-lg-row mt-3 mt-md-3 mt-lg-0">
<picture>
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/todotix.png" type="image/png">
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/todotix.webp" type="image/webp">
<img loading="lazy" src="../frontend_assets/img/our-client-say/client-icon/todotix.webp" alt="todotix">
</picture>
<div class="ml-0 ml-md-0 ml-lg-3 mt-3 mt-md-3 mt-lg-0">
<h4 class="client-nm text-capitalize">Jorge Mealla <span class="d-flex mt-1 desc mb-0 text-capitalize justify-content-center">CEO, Ticketing Startup</span><span><img class="align-self-center mr-1" width="20" height="20" src="../frontend_assets/img/our-client-say/bolivia.svg" alt="bolivia"> Bolivia</span></h4>
</div>
</div>
</div>
</div>
<div class="swiper-slide">
<div class="content-box bg-white text-center d-flex flex-column justify-content-between">
<p class="desc mb-0">"Users have reviewed the app positively. Hyperlink InfoSystem was responsive and provided excellent support. Their follow-up is particularly noteworthy."</p>
<div class="d-flex app-desc text-left flex-column flex-lg-row mt-3 mt-md-3 mt-lg-0">
<picture>
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/021-food.png" type="image/png">
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/021-food.webp" type="image/webp">
<img loading="lazy" src="../frontend_assets/img/our-client-say/client-icon/021-food.webp" alt="021-food">
</picture>
<div class="ml-0 ml-md-0 ml-lg-3 mt-3 mt-md-3 mt-lg-0">
<h4 class="client-nm text-capitalize">Owner<br><span class="d-flex mt-1 desc mb-0 text-capitalize justify-content-center justify-content-xl-start">Food Ordering App</span><span><img class="align-self-center mr-1" width="20" height="20" src="../frontend_assets/img/our-client-say/united-arab-emirates.svg" alt="uae"> United Arab Emirates</span></h4>
</div>
</div>
</div>
</div>
<div class="swiper-slide">
<div class="content-box bg-white text-center d-flex flex-column justify-content-between">
<p class="desc mb-0">"Hyperlink InfoSystem went above and beyond. Their accommodating and adaptable approach supplemented their professional management style. Hyperlink InfoSystem takes scope changes in stride. Customers can expect a flexible and communicative team that delivers on time and within budget."</p>
<div class="d-flex app-desc text-left flex-column flex-lg-row mt-3 mt-md-3 mt-lg-0">
<picture>
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/auto-cam.png" type="image/png">
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/auto-cam.webp" type="image/webp">
<img loading="lazy" src="../frontend_assets/img/our-client-say/client-icon/auto-cam.webp" alt="auto-cam">
</picture>
 <div class="ml-0 ml-md-0 ml-lg-3 mt-3 mt-md-3 mt-lg-0">
<h4 class="client-nm text-capitalize">Co-Founder<br><span class="d-flex mt-1 desc mb-0 text-capitalize justify-content-center">Motor Video Company</span><span><img class="align-self-center mr-1" width="20" src="../frontend_assets/img/uk-flag.svg" alt="uk"> London, UK</span></h4>
</div>
</div>
</div>
</div>
<div class="swiper-slide">
<div class="content-box bg-white text-center d-flex flex-column justify-content-between">
<p class="desc mb-0">"The apps meet high-quality standards and include many robust features. HyperLink is
clearly invested in the project's success. The team suggests creative ideas, shares detailed progress reports, and always delivers on time."</p>
<div class="d-flex app-desc text-left flex-column flex-lg-row mt-3 mt-md-3 mt-lg-0">
<picture>
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/ay5edmm.png" type="image/png">
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/ay5edmm.webp" type="image/webp">
<img loading="lazy" src="../frontend_assets/img/our-client-say/client-icon/ay5edmm.webp" alt="ay5edmm">
</picture>
<div class="ml-0 ml-md-0 ml-lg-3 mt-3 mt-md-3 mt-lg-0">
<h4 class="client-nm text-capitalize">Tarek Oraby,<br><span class="d-flex mt-1 desc mb-0 text-capitalize justify-content-center"> Click4Services - Owner</span><span><img class="align-self-center mr-1" width="20" height="20" src="../frontend_assets/img/our-client-say/egypt.svg" alt="egypt"> Cairo, Egypt</span></h4>
</div>
</div>
</div>
</div>
<div class="swiper-slide">
<div class="content-box bg-white text-center d-flex flex-column justify-content-between">
<p class="desc mb-0">"Hyperlink InfoSystem's team was responsive, professional, and accommodating to
concerns. They delivered a high-quality game that surpassed all expectations; it achieved 1,700 downloads on Android in 3 weeks and 500 iOS downloads in only a week without much marketing."</p>
<div class="d-flex app-desc text-left flex-column flex-lg-row mt-3 mt-md-3 mt-lg-0">
<picture>
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/virtuhunt.png" type="image/png">
<source srcset="https://www.hyperlinkinfosystem.com/frontend_assets/img/our-client-say/client-icon/virtuhunt.webp" type="image/webp">
<img loading="lazy" src="../frontend_assets/img/our-client-say/client-icon/virtuhunt.webp" alt="virtuhunt">
</picture>
<div class="ml-0 ml-md-0 ml-lg-3 mt-3 mt-md-3 mt-lg-0">
<h4 class="client-nm text-capitalize">Dwayne Van Tonder<br><span class="d-flex mt-1 desc mb-0 text-capitalize justify-content-center justify-content-xl-start">Founder, Van Holdings</span><span><img class="align-self-center mr-1" width="20" height="20" src="../frontend_assets/img/our-client-say/south-africa.svg" alt="south africa"> Johannesburg, South Africa</span></h4>
</div>
</div>
</div>
</div>
