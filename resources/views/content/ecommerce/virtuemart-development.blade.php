...
<h1 class="main-title mb-3 pt-5 h2 services-title c-black">VirtueMart</h1>
<p class="desc mb-0"><span class="c-pink">Virtuemart Offers Modules Components And Plugins That You Can Use For Your Shop </span></p>
...
<img class="m-auto img-fluid" src="/uploads/banner/1634022003.png" class="img-responsive banner-image1" alt="joomla virtueMart development company" title="Joomla VirtueMart Development Company">
</div>
</div>
</div>
...
How Virtuemart Differs From Other Open-source E-commerce Solutions</h2>
<div id="cke_pastebin" style="text-align: justify;">
If you have heard of Virtuemart before you probably already know that it is an e-commerce solution available as an open-source system for interested online users. However, what you may not have known is that it is actually meant to be used with the Joomla! Content Management System. The two are meant to be used together because they are both based on PHP programming which makes them adaptable for use within a PHP/MySQL Environment. Virtuemart&rsquo;s other claim to fame is that more e-commerce websites rely on it compared to popular e-commerce solutions like OpenCart, PrestaShop, an osCommerce. If you wish assistance in migrating to the Virtuemart system, you can always ask <strong>Hyperlink InfoSystem</strong> for their input.</div>
<div id="cke_pastebin" style="text-align: justify;">
&nbsp;</div>
<div id="cke_pastebin" style="text-align: justify;">
...
<input type="hidden" name="TotalCaptchaForm" value="fe2c4d61ba30d034004f924496dd354be163b0d496b1664d70ad4234a36b6de117090518b73c3afb9a4a59b76e74c22c1c6a64e55f8b3ca886b7626ec0ccec226OSWvGJHcDlKVqbd5/dW2Gp+u4uS4a7P1psv6GzRm9M=" />
<input type="hidden" id="country_name" name="country_name">
<input type="hidden" id="postfrom" name="postfrom" value="virtuemart-development.htm">
<div class="row">
...
<input type="text" class="form-control" id="phone1" placeholder="Contact No.*" aria-label="Contact No." maxlength="15" name="phone" required value="" onkeypress="if (!window.__cfRLUnblockHandlers) return false; return isNumberKey(event);" data-cf-modified-c11a3f460afe6173fa752f7c-="">
</div>
...
<div class="input-group-prepend">
<span class="lead f-w-600 align-self-center">1&nbsp;+&nbsp;9&nbsp;=&nbsp;</span>
<input name="captchacode" maxlength="2" class="form-control p-r-0" onkeypress="if (!window.__cfRLUnblockHandlers) return false; return isNumberKey(event);" id="captchacode" placeholder="Write Answer..." required="" aria-required="true" type="text" data-cf-modified-c11a3f460afe6173fa752f7c-="">
</div>
